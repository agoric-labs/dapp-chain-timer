...
const contractPath = myRequire.resolve(`../src/chain-timer-contract.js`);
...
const makeTestContext = async _t => {
  ...
  return {
    ...
    bundle,
    bundleCache,
    storageNode: makeMockChainStorageRoot().makeChildNode('chainTimer'),
